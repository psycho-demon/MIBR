...
from deepctr_torch.models.eta import ETA
...
if __name__ == "__main__":
    ...
    print(f'short_long_length: {short_long_length}')
    print(f'hash_bits={hash_bits}, retrieval_k={retrieval_k}')

    model = ETA(feature_columns, behavior_feature_list, device=device,
                att_weight_normalization=True, dnn_use_bn=True,
                short_long_length=short_long_length,
                hash_bits=hash_bits, retrieval_k=retrieval_k)
